...
import org.example.ch2.ex2.beans.Parrot;
import org.example.ch2.ex2.beans.Person;
import org.example.ch2.ex2.config.ProjectConfig;
...
public class AppTests {
    ...
    @DisplayName("Test that the Person instance in the Spring context" +
            "owns the Parrot instance named Koko from the Spring context")
